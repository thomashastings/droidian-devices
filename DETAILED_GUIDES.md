...
- Unlock the bootloader (Computer)
    ...
    - Other useful sources include the [vendor_zip wiki](https://wiki.vendor_zip.org/devices/) and [xda-developers](https://www.xda-developers.com/search2/)
...
- Install the vendor_image image
    - Install the file called `vendor.img` as an Image to the `vendor_image` partition
...
- [Vendor (has arb4 firmware!)](https://github.com/TryHardDood/mi-vendor-updater/releases/download/wayne-stable/fw-vendor_wayne_miui_MI6X_V11.0.6.0.PDCCNXM_f049df201b_9.0.zip)
...
- Install the required base Android version (9, 10, 11)
    ...
    - Alternatively, you can enter ADB mode and `sideload jasmine_sprout_stock_android9.zip`
- Install the required vendor_zip version
    - Install the file called `fw-vendor_wayne_miui_MI6X_V11.0.6.0.PDCCNXM_f049df201b_9.0.zip`
    - Alternatively, you can enter ADB mode and `sideload fw-vendor_wayne_miui_MI6X_V11.0.6.0.PDCCNXM_f049df201b_9.0.zip`
- Install Recovery
...
- Install adaptation package as a flashable zip (TWRP)
    ...
    - Alternatively, you can enter ADB mode and sideload the file `droidian-adaptation-xiaomi-wayne-arm64_MMMMDDYY.zip`
- Boot your device
    - Go to the `Reboot` menu and choose `System`
    - TWRP might complain that there is no OS installed, but that's fine
    - The first boot may take longer, and at least one spontaneous reboot is expected during the process
...
- [Android 9 vendor](https://github.com/ubuntu-touch-violet/ubuntu-touch-violet/releases/tag/2021051)
...
- Install the required base Android version (9, 10, 11)
    ...
    - Alternatively, you can enter ADB mode and `sideload fw_violet_miui_VIOLET_9.9.3_79d3ccd33b_9.0.zip`
- Install the required vendor_zip version
    - Install the file called `https://github.com/ubuntu-touch-violet/ubuntu-touch-violet/releases/tag/20210510`
    - Alternatively, you can enter ADB mode and `sideload https://github.com/ubuntu-touch-violet/ubuntu-touch-violet/releases/tag/20210510`
- Install the vendor_image image
    - Install the file called `boot.img` as an Image to the `boot` partition
    - Alternatively, you can enter fastboot mode and `fastboot flash boot boot.img`
- Install Recovery
...
- Install Droidian `rootfs`
    ...
    - Alternatively, you can enter ADB mode and sideload the file `droidian-rootfs-arch64_YYYYMMDD.zip`
- Install `devtools` (for stable release)
    - Install the file named `droidian-devtools-arch64_YYYYMMDD.zip` as a Zip file
    - Alternatively, you can enter ADB mode and sideload the file `droidian-devtools-arch64_YYYYMMDD.zip`
    - This component is already included in nightly builds
    - Installation is optional for stable releases, but it is recommended, because it helps with debugging
...
[UBports](https://ubuntu-touch.io/)
# Asus Zenfone Max Pro M2 (EXPERIMENTAL)
